...
export function bootstrap(): void {
	...
	// Heartbeat runs in the main app in both modes — delivery routes through
	// `workerSend()` when worker mode is on, or the in-process socket otherwise.
	// Idempotent — safe to re-call after `reloadConfig()`.
	initHeartbeat();
