		...
		<div class="bg-hub-surface border border-hub-border rounded-lg w-full max-w-md p-5 space-y-4">
			...
			<div class="space-y-3">
				...
				<label class="block">
					...
					<input type="text" bind:value={addLabel} placeholder="e.g. Default · jneaimi.com Workspace" class="w-full px-2 py-1.5 rounded bg-hub-bg border border-hub-border text-xs text-hub-text placeholder:text-hub-dim focus:outline-none focus:border-hub-cta/50" />
				</label>
				<label class="block">
