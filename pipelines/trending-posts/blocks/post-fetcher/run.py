...
PLATFORMS = os.environ.get("BLOCK_CONFIG_PLATFORMS", "tiktok,youtube,twitter,linkedin,reddit,instagram").split(",")
...
DB_SCRIPT_PATH = PIPELINE_DIR / "blocks" / "post-fetcher" / "scout_db.py"
